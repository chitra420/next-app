                ...
                <div className="container">
                    ...
                    <div className="flex justify-between items-center mb-3">
                        <div className="space-x-3">
                            ...
                            <h4 className="inline-flex text-white">KYC</h4>
                        ...
                        <form action="#">
                            ...
                            <div className="gap-3 md:gap-5 grid md:grid-cols-1">
                                ...
                                <div className="relative">
                                    <label htmlFor="aadhar" className="block text-sm mb-1 font-bold text-gray-900 ">Aadhar Card</label>
                                    <input type="text" id="aadhar" name="aadhar" placeholder="Enter 12 digit aadhar card number" className="block w-full text-black-color bg-[#F0EFFF] h-50 leading-[50px]  rounded-sm px-3  placeholder:text-optional-color outline-1" required />
                                </div>

                                <div className="relative">
                                    <label htmlFor="pancard" className="block text-sm mb-1 font-bold text-gray-900 ">PAN Card</label>
                                    <input type="text" id="pancard" name="pancard" placeholder="Enter PAN Card Number" className="block w-full text-black-color bg-[#F0EFFF] h-50 leading-[50px]  rounded-sm px-3  placeholder:text-optional-color outline-1" required />
                                </div>
