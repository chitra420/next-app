...
export default function AccountUPI() {
                ...
                <div className="container">
                    ...
                    <div className="flex justify-between items-center mb-3">
                        <div className="space-x-3">
                            ...
                            <h4 className="inline-flex text-white">UPI</h4>
                        ...
                        <form action="#">
                            ...
                            <div className="gap-3 md:gap-5 grid md:grid-cols-1">
                                ...
                                <div className="relative">
                                    <label htmlFor="upi" className="block text-sm mb-1 font-bold text-gray-900 ">New UPI </label>
                                    <input type="text" id="upi" name="upi" placeholder="Enter new UPI" className="block w-full text-black-color bg-[#F0EFFF] h-50 leading-[50px]  rounded-sm px-3  placeholder:text-optional-color outline-1" required />
                                </div>
