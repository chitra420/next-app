        ...
        <>
            <Layout>
                ...
                <section>
                    ...
                    >
                        <div className="banner-area relative pt-3 pb-8 lg:py-24 bg-fixed bg-cover bg-[url(https://wallpaper.dog/large/10790508.jpg)] ">
                            ...
                            <p className="text-lg  text-white whitespace-nowrap text-right">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 content-center">
                                    <div className="banner-content place-self-center text-center lg:text-left lg:order-1 order-2 ">
                                        ...
                                        <h1 className="text-white leading-normal text-[32px] md:text-[40px] lg:text-[50px] xl:text-[60px] mb-6 drop-shadow-lg "><span className="text-yellow-300 "> Rs 1000 </span> Cash Prize 🎉
                                        </h1>
                                        <p className="text-gray-300 text-base lg:text-xl  mb-8  ">Join the Best Quiz Site on the Web and Start Earning Today!

                                        </p>
                                        
                                        <div className="mb-3 space-x-3 flex lg:justify-start justify-center  ">
                                    ...
                                    <div className="banner-image text-center  rounded-xl relative place-self-center lg:order-2 order-1">
                                        ...
                                        <Image src="/images/new-rays.png" width={450} height={450} quality={100} className="inline-block   rays-image absolute  z-0  top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" alt="banner-image" />
                        ...
                        <div className="banner-area relative pt-3 pb-8 lg:py-24 bg-fixed bg-cover bg-[url(https://wallpaperaccess.com/full/1092605.png)] ">
                            <div className="container overflow-hidden">
                            <p className="text-lg  text-white whitespace-nowrap text-right">
                                             <span className="relative inline-flex h-3 w-3 mr-3">
                                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 "></span>
                ...
                <section className=" relative  py-6">
                    <div className="container">
                        <h4 className="text-white mb-3">Players Won 💸</h4>
                        <AliceCarousel
                            mouseTracking
                            disableDotsControls={true}
                            disableButtonsControls={true}
                                ...
                                <div className="w-full max-w-sm bg-white border border-gray-200 rounded-sm shadow p-3 ">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <div className="relative w-fit mx-auto flex-shrink-0">
                                            <Image className="w-12 h-12 rounded-full border-2 border-blue-600 p-0.5" src="/images/user-profile.jpg" width={48} height={48} alt="user image" />
                                        ...
                                        <div className="overflow-hidden">
                                            <h5 className=" truncate lg:text-lg text-base font-medium text-gray-900 ">Bonnie Green</h5>
                                            <span className="inline-block  py-1 w-full font-medium text-left ">₹30208</span>
                ...
                {/* <section className={`banner-area relative pt-3 pb-8 lg:py-24 bg-fixed bg-cover ${fadeIn ? 'fade' : ''} ${fadeIn ? 'fade-in' : ''}`} id="hero_banner_bg" style={{ backgroundImage: `url('/images/bg.png')` }}>
                    <div className="container overflow-hidden">
                        <div className="grid grid-cols-1 md:grid-cols-2 content-center">
                            <div className="banner-content place-self-center text-center lg:text-left lg:order-1 order-2 ">
                                <h3 className="text-white mb-3">Play & Win</h3>
