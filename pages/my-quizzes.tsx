...
import { BsFillEmojiSmileFill, BsFillInfoCircleFill } from "react-icons/bs";
                    ...
                    <div className="container relative">
                        ...
                        <div className="flex justify-between mb-5">
                            <div>
                                ...
                                <Link href="/my-quizzes" className="focus:outline-none text-black border border-yellow-300 bg-yellow-300 hover:bg-yellow-400 focus:ring-1 focus:ring-yellow-300 font-medium rounded-sm text-sm px-5 py-2.5  ">MY QUIZZES</Link>
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <div className="flex   bg-white border-2 border-teal-500 rounded-sm overflow-hidden mb-3">
                                ...
                                <div className="flex justify-between items-center flex-wrap w-full p-3">
                                    <div className="">
                                        <p className="text-base lg:text-lg  text-teal-600 mb-0">Quiz Of the day</p>
                                        <p className=" text-sm lg:text-base text-gray-500">12 August 2021</p>
                                    </div>

                                    <div className="my-2  ">
                                        <button type="button" className="text-white bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center ">
                            ...
                            <div className="flex   bg-white border-2 border-rose-500 rounded-sm overflow-hidden mb-3">
                                ...
                                <div className="flex justify-between items-center  w-full p-3">
                                    <div className="">
                                        <p className="text-base lg:text-lg  text-rose-600 mb-0">Computer Knowledge Quiz</p>
                                        <p className=" text-sm lg:text-base text-gray-500">12 August 2021</p>
                                    </div>

                                    <div className="my-2  ">
                                        <button type="button" className="text-white bg-rose-700 hover:bg-rose-800 focus:ring-4 focus:outline-none focus:ring-rose-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center ">
                                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div className="flex   bg-white border-2 border-blue-500 rounded-sm overflow-hidden mb-3">
                                ...
                                <div className="flex justify-between items-center flex-wrap w-full p-3">
                                    <div className="">
                                        <p className="text-base lg:text-lg  text-blue-600 mb-0">Quiz Of the day</p>
                                        <p className=" text-sm lg:text-base text-gray-500">12 August 2021</p>
                                    </div>

                                    <div className="my-2  ">
                                        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center ">
                                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                                        </button>
                                    </div>
                                </div>
