  ...
  return (
    <>
      <Layout>
        ...
        {/* Banner area */}
        <section className="banner-area relative pt-12 lg:pt-28" style={{ background: 'linear-gradient(180deg,rgba(42,20,53,0) 1.04%,#00123c 50.52%)' }}>
          <div className="container ">
            <div className="banner-content text-center ml-auto mr-auto max-w-[1010px]">
              <h1 className="text-white leading-normal text-[28px] md:text-[40px] lg:text-[45px] xl:text-[60px] mb-6 ">Learn and Earn with Our Fun and Educational <span className="text-yellow-300 "> Quizzes! </span>🎉
              </h1>
              <p className="text-gray-300 text-base lg:text-xl  mb-12  ">Join the Best Quiz Site on the Web and Start Earning Today!

              </p>
              <div className="mb-5 space-x-3 flex justify-center">

                <Link href="#" className="hover:scale-110 transition delay-150 duration-300 ease-in-out gradiant-btn w-lg mb-2  text-lg ">Play Quiz</Link>
            ...
            <div className="banner-image text-center mt-12 rounded-xl relative xl:ml-auto xl:mr-auto xl:max-w-[1094px]">
              <Image src="/images/33concept.png" width={800} height={300} quality={100} className="inline-block  animate__animated animate__fadeInUp" alt="banner-image" />
              <Image src="/images/bcard2.svg" width={200} height={100} className="absolute left-[-40px] top-[-30px] hidden xl:inline animate-custom-movebounce" alt="card image" />
              <Image src="/images/bcard1.svg" width={200} height={100} className="absolute right-[-50px] bottom-[180px] hidden xl:inline animate-custom-movebounce" alt="image" />
            </div>
          </div>
          {/* <div className="absolute -z-1 hidden xl:inline left-0 top-[14%]"><Image src="img/shape/shape16.png"  width={50} height={50} alt="shape" /></div>
          <div className="absolute -z-1 hidden lg:inline left-[5%] bottom-[27%]"><Image src="img/shape/shape17.png"  width={50} height={50} className="animate-custom-rotateme" alt="shape" /></div>*/}
          ...
          <div className="container pt-8 lg:pt-16 pb-12 lg:pb-6">
            <Image src="/images/certified.png" width={991} height={200} alt="certified" className="mx-auto" />
          </div>
        ...
        <section className="bg-[url('/images/allquiz.png')] all-quizzes py-20">
          ...
          <div className="container ">
            ...
            <div className="section-title mb-12 text-center "  id="ride_allquizzes">

              <h2 className="w-fit mx-auto relative text-[24px] md:text-[30px] lg:text-[40px]">Choose Your Quiz </h2>
              <Image src="/images/line.svg" width={200} height={30} alt="line" className="mx-auto w-[160px]" />

              <p className="text-lg lg:max-w-2xl lg:mx-auto leading-7 md:leading-8 text-gray-600 ">All your quiz need in one app</p>
            </div>
        ...
        <section className="section-area relative">
          ...
          <div className="container">
            ...
            <div className="section-title mb-8 text-center relative">
              <h2 className="text-white w-fit mx-auto relative text-[24px] md:text-[30px] lg:text-[40px] ">GyanOk Family

              </h2>
              <Image src="/images/line.svg" width={200} height={30} alt="line" className="mx-auto w-[160px]" />
              <p className="text-yellow-300 text-lg lg:max-w-2xl lg:mx-auto leading-7 md:leading-8  ">Our growth in numbers</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-5 md:grid-cols-3  lg:grid-cols-3">
              <div className="group bg-white/20 border border-gray-400 p-5 flex space-x-5 rounded-sm shadow items-center">
                ...
                <div>
                  <h3 className="font-bold lg:text-[52px]  text-[36px]  text-yellow-300">2,55,000+
                  </h3>
              ...
              <div className="group bg-white/20 border border-gray-400 p-5 flex space-x-5 rounded-sm shadow items-center">
                ...
                <div><h3 className="font-bold lg:text-[52px]  text-[36px]  text-yellow-300">60,000+
                </h3>
              ...
              <div className="group bg-white/20 border border-gray-400 p-5 flex space-x-5 rounded-sm shadow items-center">
                ...
                <div>
                  <h3 className="font-bold lg:text-[52px]  text-[36px]  text-yellow-300">4,56,000+
                  </h3>
